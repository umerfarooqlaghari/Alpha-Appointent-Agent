  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-wider text-[#071D75]">CATALOG & STOCK</p>
          <h2 className="mt-1 text-3xl font-semibold tracking-tight text-[#080C42]">Inventory Items</h2>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <label className="inline-flex cursor-pointer items-center gap-2 rounded-lg bg-[#080C42] px-4 py-2 text-sm font-semibold text-white shadow-xs transition hover:bg-[#071D75]">
      ...
      {(uploadError || uploadSuccess) && (
        <div className={`p-4 rounded-xl border ${uploadError ? "bg-rose-50 border-rose-200 text-rose-800" : "bg-blue-50 border-blue-200 text-[#080C42]"}`}>
                  ...
                  <td className="px-5 py-4">
                    <button 
                      ...
                      className={`inline-flex items-center gap-1.5 text-xs font-semibold transition ${
                        item.is_disabled ? "text-slate-400 hover:text-slate-600" : "text-[#071D75] hover:text-[#080C42]"
                      }`}
                    >
                      {item.is_disabled ? (
                        <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <label className="block text-xs font-semibold text-stone-700">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-lg border border-slate-200 p-2 text-sm focus:border-[#071D75] focus:ring-1 focus:ring-[#071D75] focus:outline-none"
                  />
                </label>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <label className="block text-xs font-semibold text-slate-700">
                  ...
                  <select
                    ...
                    className="mt-1 w-full rounded-lg border border-slate-200 p-2 text-sm focus:border-[#071D75] focus:ring-1 focus:ring-[#071D75] focus:outline-none bg-white"
                  >
